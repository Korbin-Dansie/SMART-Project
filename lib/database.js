...
function createTables() {
  ...
  con.execute(sql, function (err, results, fields) {
    if (err) {
      ...
      console.log(
        "database.js: table `account_type` created if it didn't exist"
      );
    }
  });
  ...
  con.execute(sql, function (err, results, fields) {
    if (err) {
      ...
      console.log(
        "database.js: table `contact_type` created if it didn't exist"
      );
    }
  });
  ...
  con.execute(sql, function (err, results, fields) {
    if (err) {
      ...
      console.log(
        "database.js: table `contact_information` created if it didn't exist"
      );
    }
  });
  ...
  con.execute(sql, function (err, results, fields) {
    if (err) {
      ...
      console.log(
        "database.js: table `application_status` created if it didn't exist"
      );
    }
  });
  ...
  con.execute(sql, function (err, results, fields) {
    if (err) {
      ...
      console.log(
        "database.js: table `public_school_level` created if it didn't exist"
      );
    }
  });
  ...
  con.execute(sql, function (err, results, fields) {
    if (err) {
      ...
      console.log(
        "database.js: table `student_status` created if it didn't exist"
      );
    }
  });
  ...
  con.execute(sql, function (err, results, fields) {
    if (err) {
      ...
      console.log(
        "database.js: table `application` created if it didn't exist"
      );
    }
  });
  ...
  con.execute(sql, function (err, results, fields) {
    if (err) {
      ...
      console.log(
        "database.js: table `social_worker_student` created if it didn't exist"
      );
    }
  });
  ...
  con.execute(sql, function (err, results, fields) {
    if (err) {
      ...
      console.log(
        "database.js: table `social_worker_student_note` created if it didn't exist"
      );
    }
  });
  ...
  con.execute(sql, function (err, results, fields) {
    if (err) {
      ...
      console.log(
        "database.js: table `student_sponsor` created if it didn't exist"
      );
    }
  });
  ...
  sql =
    "CREATE TABLE IF NOT EXISTS `smart_project`.`subject_name` (\n" +
  ...
  con.execute(sql, function (err, results, fields) {
    if (err) {
      ...
      console.log(
        "database.js: table `subject_name` created if it didn't exist"
      );
    }
  });
  ...
  con.execute(sql, function (err, results, fields) {
    if (err) {
      ...
      console.log(
        "database.js: table `assignment_status` created if it didn't exist"
      );
    }
  });
  ...
  con.execute(sql, function (err, results, fields) {
    if (err) {
      ...
      console.log(
        "database.js: table `day_of_week` created if it didn't exist"
      );
    }
  });
  ...
  con.execute(sql, function (err, results, fields) {
    if (err) {
      ...
      console.log(
        "database.js: table `certificate` created if it didn't exist"
      );
    }
  });
  ...
  con.execute(sql, function (err, results, fields) {
    if (err) {
      ...
      console.log(
        "database.js: table `student_certificate` created if it didn't exist"
      );
    }
  });
  ...
  con.execute(sql, function (err, results, fields) {
    if (err) {
      ...
      console.log(
        "database.js: table `student_feeding` created if it didn't exist"
      );
    }
  });
  ...
  con.execute(sql, function (err, results, fields) {
    if (err) {
      ...
      console.log(
        "database.js: table `student_attendance` created if it didn't exist"
      );
    }
  });
  ...
  con.execute(sql, function (err, results, fields) {
    if (err) {
      ...
      console.log(
        "database.js: table `student_public_school_schedule` created if it didn't exist"
      );
    }
  });
  ...
  sql =
    ...
    "  `grade` INT UNSIGNED NOT NULL DEFAULT 0 COMMENT 'If the status is null then the assignment has not been graded yet',\n" +
  ...
  con.execute(sql, function (err, results, fields) {
    if (err) {
      ...
      console.log(
        "database.js: table `student_assignment` created if it didn't exist"
      );
    }
  });
  ...
  con.execute(sql, function (err, results, fields) {
    if (err) {
      ...
      console.log(
        "database.js: table `student_assignment_document` created if it didn't exist"
      );
    }
  });
  ...
  con.execute(sql, function (err, results, fields) {
    if (err) {
      ...
      console.log(
        "database.js: table `assignment_note` created if it didn't exist"
      );
    }
  });
  ...
  con.execute(sql, function (err, results, fields) {
    if (err) {
      ...
      console.log(
        "database.js: table `student_schedule` created if it didn't exist"
      );
    }
  });
  ...
  con.execute(sql, function (err, results, fields) {
    if (err) {
      ...
      console.log(
        "database.js: table `instructor_schedule` created if it didn't exist"
      );
    }
  });
} // end of createTables()
...
function createStoredProcedures() {
  ...
  ")\n" +
  "BEGIN\n" +
  " SELECT assignment.assignment_name, assignment.due_date, assignment_status.status, student_assignment.submission_date, student_assignment.grade, assignment.points_possible\n" +
  " FROM student_assignment\n" +
  " JOIN assignment ON assignment.assignment_id = student_assignment.assignment_id\n" +
  " JOIN assignment_status ON assignment_status.assignment_status_id = student_assignment.assignment_status_id\n" +
  ...
  runSQL("CREATE PROCEDURE `create_class`(\n" + 
  ...
  runSQL("CREATE PROCEDURE `create_class_time`(\n" + 
  ...
  runSQL("CREATE PROCEDURE `create_instructor_schedule`(\n" + 
  "	IN email VARCHAR(255),\n" + 
  "    IN class_id INT UNSIGNED\n" + 
  ")\n" + 
  "BEGIN\n" + 
...
function addTableData() {
  ...
  runSQL("CALL create_public_school_level('6')",
    "Level 6 for public school level created"
  );
  runSQL("CALL create_public_school_level('7')",
    "Level 7 for public school level created"
  );
  ...
  runSQL("CALL create_public_school_level('adult')",
    "Level adult for public school level created"
  );
  ...
  // Create the levels
  runSQL("CALL create_level('1')", "Level 7 created");
  runSQL("CALL create_level('2')", "Level 9 created");
  runSQL("CALL create_level('3')", "Level 10 created");
  runSQL("CALL create_level('4')", "Level 11 created");
  runSQL("CALL create_level('5')", "Level 12 created");
  ...
  runSQL("CALL create_application(3, 1, '2005-08-14', 1.1, 1.1, FALSE, FALSE, 'essay', @id)", "Inserted sample Application");
  runSQL("CALL create_application(4, 1, '2005-08-14', 1.1, 1.1, FALSE, FALSE, 'essay', @id)", "Inserted sample Application");
  runSQL("CALL create_application(5, 1, '2005-08-14', 1.1, 1.1, FALSE, FALSE, 'essay', @id)", "Inserted sample Application");
  runSQL("CALL create_application(6, 1, '2005-08-14', 1.1, 1.1, FALSE, FALSE, 'essay', @id)", "Inserted sample Application");
  runSQL("CALL create_application(7, 1, '2005-08-14', 1.1, 1.1, FALSE, FALSE, 'essay', @id)", "Inserted sample Application");
  runSQL("CALL create_application(8, 1, '2005-08-14', 1.1, 1.1, FALSE, FALSE, 'essay', @id)", "Inserted sample Application");
  ...
  // Dummy assignments
  runSQL("INSERT INTO assignment (assignment_name, due_date, points_possible, class_id) VALUES('Week 1 Vocab', '2023-04-20', 10, 1);", "Added dummy assignment 1 to class 1")
  runSQL("INSERT INTO assignment (assignment_name, due_date, points_possible, class_id) VALUES('Week 1 Quiz', '2023-04-20', 12, 1);", "Added dummy assignment 2 to class 1")

  runSQL("INSERT INTO student_assignment (student_id, assignment_id, assignment_status_id, submission_date, grade, can_sponsor_view) VALUES(8, 1, 2, '2023-04-20', 9, false);", "Gave student 8 assignment 1")
  runSQL("INSERT INTO student_assignment (student_id, assignment_id, assignment_status_id, submission_date, grade, can_sponsor_view) VALUES(8, 2, 2, '2023-04-20', 10, false);", "Gave student 8 assignment 2")

  runSQL("INSERT INTO student_assignment (student_id, assignment_id, assignment_status_id, submission_date, grade, can_sponsor_view) VALUES(2, 1, 2, '2023-04-20', 7, false);", "Gave student 2 assignment 1")
  runSQL("INSERT INTO student_assignment (student_id, assignment_id, assignment_status_id, submission_date, grade, can_sponsor_view) VALUES(2, 2, 1, '2023-04-20', 5, false);", "Gave student 2 assignment 2")
