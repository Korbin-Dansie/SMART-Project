...
function createStoredProcedures() {
  ...
  " IN  applicationID MEDIUMINT,\n" + 
  " OUT guardianID MEDIUMINT\n" + 
  ")\n" + 
  "BEGIN\n" + 
  " SET guardianID = (SELECT person_id FROM guardian WHERE application_id = applicationID);\n" +
  ...
  runSQL("CREATE PROCEDURE IF NOT EXISTS select_guardian_phone (\n" +
  " IN guardian_id MEDIUMINT UNSIGNED\n" +
  ")\n" +
  "BEGIN\n" +
  " SELECT value\n" +
  " FROM contact_information\n" +
  " WHERE person_id = guardian_id\n" +
  " AND contact_type_id = 1;\n" +  // 1 is the phone contact type
  "END;",
  "Procedure select_guardian_phone created if it didn't already exist.");

  runSQL("CREATE PROCEDURE IF NOT EXISTS select_guardian_email (\n" +
  " IN guardian_id MEDIUMINT UNSIGNED\n" +
  ")\n" +
  "BEGIN\n" +
  " SELECT value\n" +
  ...
  "END;",
  "Procedure select_guardian_email created if it didn't already exist.");
