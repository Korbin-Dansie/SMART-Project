...
function createTables() {
  ...
  "  `public_school_gpa` TINYINT UNSIGNED NOT NULL,\n" +
...
function createStoredProcedures() {
  ...
  // Guardian information not yet handled, probably will be in a different sproc?
  ...
  // TODO: sproc for retrieving contact info
...
function addTableData() {
  ...
  runSQL("INSERT INTO public_school_level(level)\n" + 
  "VALUES('Eighth');", "Inserted testing public school grade level");

  runSQL("INSERT INTO application(person_id, application_status_id, public_school_level_id, public_school_gpa, student_id, date_of_application, date_of_birth, latitude, longitude, transportation_assistance, meal_assistance, essay)\n" +
  "VALUES(1, 1, 1, 15, NULL, '2023-01-10', '2007-01-01', 41.24122, 2.10265, false, false, 'I want to learn English/IT');", "Inserted test application");

  runSQL("INSERT INTO application(person_id, application_status_id, public_school_level_id, public_school_gpa, student_id, date_of_application, date_of_birth, latitude, longitude, transportation_assistance, meal_assistance, essay)\n" +
  "VALUES(1, 2, 1, 15, NULL, '2023-01-10', '2007-01-01', 41.24122, 2.10265, false, false, 'I want to learn English/IT');", "Inserted test application");
