...
function createStoredProcedures() {
  ...
  "	OUT student_application_latitude DECIMAL(11,8), \n" + 
  "	OUT student_application_longitude DECIMAL(11,8) \n" + 
  ")\n" + 
  "BEGIN\n" + 
  ...
  "    student_application_latitude, student_application_longitude\n" + 
  "  FROM student \n" + 
  "  JOIN student_status ON student_status.student_status_id = student.student_status_id\n" + 
  "  JOIN application ON application.student_id = student.student_id\n" + 
  "  JOIN person ON person.person_id = application.person_id\n" + 
  ...
  "  FROM guardian \n" + 
  "  JOIN application ON application.application_id = guardian.application_id\n" + 
  ...
  ")\n" + 
  "BEGIN\n" + 
  "	 SELECT DISTINCT subject_name.subject_name, `level`.level_name, semester.`description` \n" + 
  "  FROM student_schedule   \n" + 
...
function addTableData() {
  ...
  runSQL("INSERT INTO student_schedule (student_id, class_time_id) VALUES(1, 2);", "Assigned a student to a class");
  runSQL("INSERT INTO student_schedule (student_id, class_time_id) VALUES(1, 3);", "Assigned a student to a class");
  ...
  // Add contact info for students
  runSQL("INSERT INTO contact_information (person_id, contact_type_id, `value`) VALUES (3, 1, '345612')","Added contact info for a student");
  runSQL("INSERT INTO contact_information (person_id, contact_type_id, `value`) VALUES (3, 2, 'email@example.mail')","Added contact info for a student");
  runSQL("INSERT INTO contact_information (person_id, contact_type_id, `value`) VALUES (4, 1, '75236555')","Added contact info for a student");
  runSQL("INSERT INTO contact_information (person_id, contact_type_id, `value`) VALUES (4, 2, 'mail2@mail.mail')","Added contact info for a student");
  runSQL("INSERT INTO contact_information (person_id, contact_type_id, `value`) VALUES (5, 1, '8465312')","Added contact info for a student");
  runSQL("INSERT INTO contact_information (person_id, contact_type_id, `value`) VALUES (5, 2, 'mail3@example.com')","Added contact info for a student");
  runSQL("INSERT INTO contact_information (person_id, contact_type_id, `value`) VALUES (6, 1, '15672')","Added contact info for a student");
  runSQL("INSERT INTO contact_information (person_id, contact_type_id, `value`) VALUES (6, 2, 'student@mail.org')","Added contact info for a student");
  runSQL("INSERT INTO contact_information (person_id, contact_type_id, `value`) VALUES (7, 1, '79643')","Added contact info for a student");
  runSQL("INSERT INTO contact_information (person_id, contact_type_id, `value`) VALUES (7, 2, 'person@example.org')","Added contact info for a student");
  runSQL("INSERT INTO contact_information (person_id, contact_type_id, `value`) VALUES (8, 1, '35487354')","Added contact info for a student");
  runSQL("INSERT INTO contact_information (person_id, contact_type_id, `value`) VALUES (8, 2, 'cool@mail.com')","Added contact info for a student");
  runSQL("INSERT INTO contact_information (person_id, contact_type_id, `value`) VALUES (9, 1, '543152')","Added contact info for a student");
  runSQL("INSERT INTO contact_information (person_id, contact_type_id, `value`) VALUES (9, 2, 'not@example.com')","Added contact info for a student");
  runSQL("INSERT INTO contact_information (person_id, contact_type_id, `value`) VALUES (10, 1, '435216354')","Added contact info for a student");
  runSQL("INSERT INTO contact_information (person_id, contact_type_id, `value`) VALUES (10, 2, 'house@mail.com')","Added contact info for a student");

  // Create a new student social worker id
  ...
  runSQL("CALL award_certificate(1,1);", "Awarded a certificate to a student");
