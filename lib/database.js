...
function addTableData() {
  ...
  // Create meal times
  runSQL(
    "CALL create_meal_time('Breakfast')",
  ...
  runSQL(
    "CALL create_assignment_status('Fail')",
    "Created assignment status Fail"
  );
  runSQL(
    "CALL create_assignment_status('Success')",
    "Created assignment status Success"
  );

  // Created semesters
  runSQL(
    "CALL create_semester('Spring 2023', '2023-01-09', '2023-04-24')",
    "Created Spring semster"
  );
  runSQL(
    "CALL create_semester('Summer 2023', '2023-05-08', '2023-08-11')",
    "Created Summer semster"
  );
  runSQL(
    "CALL create_semester('Fall 2023', '2023-08-28', '2023-12-08')",
  ...
  runSQL(
    "CALL create_user('Super Admin', 'John', 'Doe', 'admin@a.a', '60db1f65a6617317ba485b74ac5c0ee67a80d0aef7ca531af6c7f31ac57ea7ad', '7e43af8c89806bcf', @result)",
    "Created a new super admin - John Doe"
  );

  // password is i
  runSQL(
    "CALL create_user('Instructor', 'Mark', 'Rosewater', 'i@i.i', 'ba4818e9bb7d377dc759f379bb67cccbcb621e3bded37628ed76530a1c99195d', '75cf7155b98fbf45', @result)",
  ...
  runSQL(
    "INSERT INTO application(person_id, application_status_id, public_school_level_id, student_id, date_of_application, date_of_birth, latitude, longitude, transportation_assistance, meal_assistance, essay)\n" +
      "VALUES(1, 1, 1, NULL, '2023-01-10', '2007-01-01', 41.24122, 2.10265, false, false, 'I want to learn English/IT');",
    "Inserted test application"
  );

  runSQL(
    "INSERT INTO application(person_id, application_status_id, public_school_level_id, student_id, date_of_application, date_of_birth, latitude, longitude, transportation_assistance, meal_assistance, essay)\n" +
      "VALUES(1, 2, 1, NULL, '2023-01-10', '2007-01-01', 41.24122, 2.10265, true, false, 'I want to learn English/IT');",
    "Inserted test application"
  );

  runSQL(
    "INSERT INTO contact_information(person_id, contact_type_id, value)\n" +
      "VALUES(1, 1, 'contact');",
    "Inserted sample contact_information"
  );

  runSQL(
    "INSERT INTO guardian(person_id, application_id, annual_income) VALUES(1, 1, 15000);",
    "Inserted sample guardian"
  );
} // end of addTableData()
