...
function createStoredProcedures() {
  ...
  ")\n" +
  "BEGIN\n" +
  " SELECT start_time, end_time, day_of_week.name\n" +
  " FROM class_time\n" +
...
function addTableData() {
  ...
  // Create a new class
  runSQL("INSERT INTO `class`\n" +
  "(`semester_id`,\n" +
  "`subject_id`,\n" +
  "`start_date`,\n" +
  "`end_date`)\n" +
  "VALUES\n" +
  "(1,	7,	'2023-01-09',	'2023-04-24');", "Create a new class");

  // Create some example class times
  runSQL("INSERT INTO `smart_project`.`class_time`\n" +
  "(`class_id`,\n" +
  "`day_of_week_id`,\n" +
  "`group`,\n" +
  "`start_time`,\n" +
  "`end_time`)\n" +
  "VALUES\n" +
  "(1,	2,	0,	'08:00:00',	'09:00:00'),\n" +
  "(1,	4,	0,	'08:00:00',	'09:00:00'),\n" +
  "(1,	3,	1,	'08:00:00',	'09:00:00'),\n" +
  "(1,	5,	1,	'08:00:00',	'09:00:00');", "Create some example class times");

  // Assing the instructor to the class
  runSQL("INSERT INTO `instructor_schedule`\n" +
  "(`user_id`,\n" +
  "`class_id`)\n" +
  "VALUES\n" +
  "(2,	1);", "Assign instructor to the class");
