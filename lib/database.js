...
function addTableData() {
  ...
  runSQL("CALL create_subject(1, 4)", "English 4 Created");
  runSQL("CALL create_subject(1, 5)", "English 5 Created");
  ...
  runSQL("CALL create_subject(2, 4)", "IT 4 Created");
  runSQL("CALL create_subject(2, 5)", "IT 5 Created");
  ...
  runSQL("INSERT INTO student_assignment (student_id, assignment_id, assignment_status_id, submission_date, grade, can_sponsor_view) VALUES(8, 1, NULL, '2023-04-20', 0, false);", "Gave student 8 assignment 1")
